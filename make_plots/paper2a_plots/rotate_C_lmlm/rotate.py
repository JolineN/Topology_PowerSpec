...
sub2 = fig.add_subplot(2,1,2) # two rows, two columns, fist cell
axim = plot_ax(rot_cov, sub2, 1, 2, 10, 2, 10, 'Randomly rotated coordinate system')
fig.subplots_adjust(right=0.8)
cbar_ax = fig.add_axes([0.8, 0.05, 0.04, 0.9])
