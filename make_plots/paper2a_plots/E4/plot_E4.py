...
E4_no_shift = np.load('kl_E4_x0_0_y0_0.npy')
E4_shift = np.load('kl_E4_x0_035_y0_m02.npy')
...
cov = np.load('E4_no_shift_corr_matrix_l_2_10_lp_2_10.npy')
...
cov = np.load('E4_with_shift_corr_matrix_l_2_10_lp_2_10.npy')
axim = plot_ax(cov, sub2, 1, 2, 10, 2, 10, r'$\boldsymbol{x}_0=(0.35, -0.20, 0)L_{\mathrm{LSS}}$')
...
sub3.plot(L_list, E4_no_shift, label=r'$\boldsymbol{x}_0=(0, 0, 0)L_{\mathrm{LSS}}$', color='red')
sub3.plot(L_list, E4_shift, label=r'$\boldsymbol{x}_0=(0.35, -0.20, 0)L_{\mathrm{LSS}}$', color='blue')
