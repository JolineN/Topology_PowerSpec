...
E5_no_shift = np.load('kl_E5_x0_0_y0_0.npy')
E5_shift = np.load('kl_E5_x0_035_y0_m06.npy')
...
cov = np.load('E5_no_shift_corr_matrix_l_2_10_lp_2_10.npy')
...
cov = np.load('E5_with_shift_corr_matrix_l_2_10_lp_2_10.npy')
axim = plot_ax(cov, sub2, 1, 2, 10, 2, 10, r'$\boldsymbol{x}_0=(0.35, -0.61, 0)L_{\mathrm{LSS}}$')
...
sub3.plot(L_list, E5_no_shift, label=r'$\boldsymbol{x}_0=(0, 0, 0)L_{\mathrm{LSS}}$', color='red')
sub3.plot(L_list, E5_shift, label=r'$\boldsymbol{x}_0=(0.35, -0.61, 0)L_{\mathrm{LSS}}$', color='blue')
sub3.set_ylabel(r'$D_{\mathrm{KL}}(p || q)$')
sub3.yaxis.set_label_coords(-0.128, 0.5)
sub3.set_xlabel(r'$L_B / L_{\mathrm{circle}}$')
sub3.set_xlim([0.7, 1.3])
sub3.set_ylim([0.1, 1.5*1e2])
