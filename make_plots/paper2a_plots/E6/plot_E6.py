...
E6_no_shift = np.load('kl_E6_x0_0_y0_0.npy')
E6_shift = np.load('kl_E6_x0_m05_y0_025.npy')
...
cov = np.load('E6_no_shift_corr_matrix_l_2_10_lp_2_10.npy')
...
cov = np.load('E6_with_shift_corr_matrix_l_2_10_lp_2_10.npy')
axim = plot_ax(cov, sub2, 1, 2, 10, 2, 10, r'$\boldsymbol{x}_0=(-0.5, 0.25, 0)L_{\mathrm{LSS}}$')
...
sub3.plot(L_list, E6_no_shift, label=r'$\boldsymbol{x}_0=(0, 0, 0)L_{\mathrm{LSS}}$', color='red')
sub3.plot(L_list, E6_shift, label=r'$\boldsymbol{x}_0=(-0.5, 0.25, 0)L_{\mathrm{LSS}}$', color='blue')
sub3.set_ylabel(r'$D_{\mathrm{KL}}(p || q)$')
sub3.yaxis.set_label_coords(-0.128, 0.65)
sub3.set_xlabel(r'$L / L_{\mathrm{circle}}$')
sub3.set_xlim([0.7, 1.3])
sub3.set_ylim([0.1, 1.5*1e3])
sub3.axhline(1, color='black', linestyle='--')
sub3.axvline(1, ymin=0, ymax=0.7, color='black', linestyle='--')
sub3.set_yscale('log')
sub3.legend(frameon=False, loc='upper right')
fig.suptitle(r'$E_6$')
plt.savefig('E6.pdf')