...
c_l_a = a.make_alm_realizations(plot_alm=True, save_alm = False, it=1)
...
_, normalized = a.calculate_c_lmlpmp(
  only_diag = False,
  normalize = True,
  save_cov = True,
  plotting = True,
  plot_param={
    ...
    'lp_ranges': np.array([[2, 20], [150, 151], [100, 101]]),
  }
)

np.save('tmp.npy', normalized)
