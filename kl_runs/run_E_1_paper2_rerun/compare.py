...
for beta in beta_list:
  ...
  for i, L in enumerate(L_list):
    ...
    np.save('kl_E1_beta_{}.npy'.format(beta), kl)
    np.save('kl_Q_P_E1_beta_{}.npy'.format(beta), kl_Q_ass_P)
    np.save('at_E1_beta_{}.npy'.format(beta), a_t)