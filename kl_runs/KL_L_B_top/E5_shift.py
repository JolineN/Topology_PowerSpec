...
for top in topology_list:
  ...
  for i, L in enumerate(L_list):
    ...
    param['alpha'] = 90
    param['gamma'] = 0
    param['x0'] = np.array([0.35, -1.4/4*np.sqrt(3), 0], dtype=np.float64)
    ...
    np.save('kl_{}_x0_035_y0_m06.npy'.format(top), kl)
    np.save('kl_Q_ass_P{}_x0_035_y0_m06.npy'.format(top), kl_Q_ass_P)
    np.save('at_{}_x0_035_y0_m06.npy'.format(top), a_t)