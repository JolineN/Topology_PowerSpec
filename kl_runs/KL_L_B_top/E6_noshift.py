...
for top in topology_list:
  ...
  for i, L in enumerate(L_list):
    ...
    np.save('kl_{}_x0_0_y0_0.npy'.format(top), kl)
    np.save('kl_Q_ass_P{}_x0_0_y0_0.npy'.format(top), kl_Q_ass_P)
    np.save('at_{}_x0_0_y0_0.npy'.format(top), a_t)