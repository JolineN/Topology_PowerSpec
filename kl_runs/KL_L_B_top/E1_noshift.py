...
for top in topology_list:
  ...
  for i, L in enumerate(L_list):
    ...
    np.save('kl_{}_beta_90.npy'.format(top), kl)
    np.save('kl_Q_ass_P{}_beta_90.npy'.format(top), kl_Q_ass_P)
    np.save('at_{}_beta_90.npy'.format(top), a_t)