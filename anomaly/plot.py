...
num=2500
S_2_coords = np.load('S_2_coords_E1_{}_L11.npy'.format(num))
S_3_coords = np.load('S_3_coords_E1_{}_L11.npy'.format(num))
t_3 = np.load('t_3_E1_{}_L11.npy'.format(num))

plt.figure()
plt.hist(t_3, bins=30)
plt.savefig('tmp_t_3_{}.pdf'.format(num))
...
plt.savefig('dot_{}.pdf'.format(num))